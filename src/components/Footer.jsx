...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#f8f9fa] dark:bg-zinc-950 text-zinc-600 dark:text-zinc-400 border-t border-zinc-200/60 dark:border-zinc-900 transition-colors duration-300">
