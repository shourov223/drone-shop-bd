    ...
    <section className="bg-zinc-50 dark:bg-zinc-950 min-h-screen flex items-center justify-center p-4 md:p-6 font-sans antialiased pt-[100px] transition-colors duration-200">
      <div className="w-full max-w-[450px] bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 rounded-2xl p-6 md:p-8 shadow-xs hover:shadow-md transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-zinc-700 dark:text-zinc-300 text-xs sm:text-sm font-bold mb-1.5">
              Full Name
            </label>
            <div className="relative">
              <input
                ...
                className={`w-full pl-11 pr-4 py-2.5 bg-zinc-50 dark:bg-zinc-950 border ${
                  errors.name
              ...
              />
              <FiUser className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 dark:text-zinc-500 text-base" />
            </div>
            {errors.name && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full pl-11 pr-11 py-2.5 bg-zinc-50 dark:bg-zinc-950 border ${
                  errors.password
                    ? "border-red-500 focus:border-red-500"
                    : "border-zinc-200 dark:border-zinc-800 focus:border-zinc-400 dark:focus:border-zinc-600"
                } rounded-xl text-sm font-semibold text-zinc-800 dark:text-zinc-100 outline-none transition-all`}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#f06236] hover:bg-[#de5328] dark:bg-orange-600 dark:hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg text-sm sm:text-base tracking-wide cursor-pointer active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed pt-3"
          >
            {isLoading ? (
